...
//Задание 2 Вывести в консоль через шаблонные строки заработную плату всех работников в таком формате: 
...
// Задание 4 вывести в консоль значения всех элементов массива и соответствующие им индексы в таком виде:
...
//length (длина слова). Вывести этот массив в консоль.
let arr = [
    let car = ["BMW", "Audi", "Opel", "Volva"];

    let secondcar = [{word: 'BMW'}, {word: 'Audi'}, {word: 'Opel'}, {word: 'Volva'} ];
    
    
    for(let i = 0; i < car.length; i++) {
    secondcar.push({'word': car[i]});
    }
    console.log(secondcar);
//2) Пройтись по полученному массиву объектов и вывести в консоль строки вида "слово - длина_слова", например "картошка - 8"
for (let i = 0; i < car.length; i++) {
    console.log(`слово ${secondcar[i].word} длина_слова ${secondcar[i].word.length}`)